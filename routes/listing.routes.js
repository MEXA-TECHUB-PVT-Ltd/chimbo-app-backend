...
import {
    ...
    getByUser, uploadVideo, getIDs, searchByCity, chartData,getIDsByLocation,AddLikeByUserId,UnLikeByUserId
...
router.get("/unlikeListingByUser/:userId/:ListingId", UnLikeByUserId);
